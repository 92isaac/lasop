            ...
            <label for="D0">Weekdays</label>
             <div className="sub255">
                <div className="display-time">
                    <input type="radio" name="level2" value={time.timeOfStudy} onChange={e=> setTime({timeOfStudy:e.target.value})} id="D10"/>
                    <label for="D10">9am - 2pm</label>
                </div>
                <div className="display-time">
                    <input type="radio" name="level2" value={time.timeOfStudy} onChange={e=> setTime({timeOfStudy:e.target.value})} id="D11"/>
                    <label for="D11">3pm - 6pm</label>
                </div>
            </div>
        </div>
        <div>
            <input type="radio" name="level1" value={time.timeOfStudy} onChange={e=> setTime({timeOfStudy:e.target.value})} id="D1"/>
